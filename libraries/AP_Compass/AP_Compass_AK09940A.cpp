...
#define AK09940A_CNTL1                     0x30
#define AK09940A_DTSET                     0x20 // External Trigger 
#define AK09940A_CNTL3                     0x32

/* Modes*/
#define AK09940A_POWERDOWN_MODE            0x00
#define AK09940A_CONTINOUS_MODE1           0x02
#define AK09940A_CONTINOUS_MODE2           0x04
#define AK09940A_CONTINOUS_MODE3           0x06
#define AK09940A_CONTINOUS_MODE4           0x08
#define AK09940A_CONTINOUS_MODE5           0x0A
#define AK09940A_CONTINOUS_MODE6           0x0C
#define AK09940A_CONTINOUS_MODE7           0x0E
#define AK09940A_CONTINOUS_MODE8           0x0F


#define AK09940A_SELTEST_MODE              0x10
...
bool AP_Compass_AK09940A::init() 
{
    ...
    if (!_check_id()) return false;

    _setup_mode(AK09940A_CONTINOUS_MODE4);
    _set_sensordrive(AK09940A_SENSORDRIVE_LN1);

    _dev->set_device_type(DEVTYPE_AK09940A);
    if (!register_compass(_dev->get_bus_id())) return false;
...
void AP_Compass_AK09940A::_update()
{
    ...
    if (!_dev->read_registers(AK09940A_ST1, (uint8_t *)&data, sizeof(data))) return;
